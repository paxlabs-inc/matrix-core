...
# Centra AI Protocol License

[![License](https://img.shields.io/badge/License-Centra%20AI%20Protocol-004CED?style=for-the-badge&labelColor=000000)](#)
[![SPDX](https://img.shields.io/badge/SPDX-LicenseRef--Centra--ai--Protocol-004CED?style=for-the-badge&labelColor=000000)](#)
...
> You may **read, use, deploy, and integrate** Centra AI Protocol.
>
...
**1.1 "Licensed Work"** means the Centra AI Protocol stack as released in this repository, including:

- **(a)** the core Centra AI Protocol execution engine, instruction/handler interfaces, example instruction libraries published by Sidiora Labs, SDK stubs, schemas, configuration, tests, tooling, bytecode/ABIs, and deployment scripts;
- **(b)** all documentation and technical specifications published by Sidiora Labs; and
- **(c)** all updates, patches, and new versions of the foregoing that Sidiora Labs publishes under this license.
...
**1.3 "Commercial License"** means a separate written agreement between Sidiora Labs and You (and/or Your Affiliates) that grants You the right to engage in Commercial Use of the Licensed Work subject to negotiated terms, conditions, and fees.
...
**2.1 Source and Object Use.** Subject to Sections 3–11, Sidiora Labs grants You a worldwide, non‑exclusive license to use, copy, and distribute unmodified source/object forms of the Licensed Work.
...
such use constitutes Commercial Use and requires obtaining a Commercial License from Sidiora Labs. *Even where Pure Caller Use is not met, see [§5.3](#5-commercial-trigger) for the current enforcement waiver applicable to Volume Activities.*
...
| | Requirement |
|---|---|
| **A** | Publish under this same license (`LicenseRef-Centra-ai-Protocol`), at no charge, complete corresponding source of any portions of Your work that modify, extend, incorporate, or otherwise rely on the Licensed Work. |
| **B** | Preserve existing copyright, license, and third‑party notices. |
| **C** | Add prominent attribution: **"Powered by Centra AI Protocol — © Sidiora Labs 2026"** in repository README and UI where applicable. |
...
**5.1 Commercial Use.** Any Commercial Use of the Licensed Work requires a Commercial License from Sidiora Labs, unless otherwise expressly stated. Commercial Use means any use of the Licensed Work that provides, enables, or is integrated into any product, service, system, workflow, or operation from which You or Your Affiliates derive, or reasonably expect to derive, monetary or in‑kind commercial value, directly or indirectly, including through Charged Fees or other consideration.

**5.2 Triggers.** Without limiting §5.1, You (and Your Affiliates) **must obtain a Commercial License** from Sidiora Labs if any of the following occur:
...
**5.4 Contact Requirement.** Crossing any Trigger or any other Commercial Use requires you to contact Sidiora Labs within **15 days** at **`license@Paxeer.app`** to execute a Commercial License. Commercial License terms are confidential and may change.

---

## 6. Audit

Once per year, Sidiora Labs may request an independent revenue/LUC audit (under NDA) at Sidiora Labs's expense; if under‑reporting exceeds **5%**, You reimburse reasonable audit costs in addition to other remedies.

Sidiora Labs may also request an additional attestation **"for cause"** (objective indications of a Trigger). You must reasonably cooperate with any such attestation, including providing accurate records, logs, and other information reasonably necessary.

---

## 7. Additional Intellectual Property Terms

**7.1 Patents.** Sidiora Labs grants a limited, non‑exclusive, worldwide license under Sidiora Labs's patent claims that read on the Licensed Work **solely to the extent necessary** to exercise the rights expressly granted to You under this License.
...
This patent license **terminates** if you (or your Affiliates) stop using the Licensed Work or assert any patent claim against Sidiora Labs or compliant users of the Licensed Work. No implied patent license is granted beyond this clause.

**7.2 Trademarks & Branding.** No rights are granted to use any Sidiora Labs / Centra AI Protocol / Paxeer Network names, logos, or trademarks, or any "Powered by Centra AI" or similar designation, except solely to make truthful statements of compatibility or integration. Any use must comply with Sidiora Labs's brand guidelines and may require separate written permission.
...
**7.4 No Endorsement.** You must not suggest Sidiora Labs endorses or certifies Your product absent a written agreement.

---

## 8. Warranty & Liability

> **THE LICENSED WORK IS PROVIDED BY Sidiora Labs "AS IS" AND "AS AVAILABLE,"** WITHOUT WARRANTIES OF ANY KIND, EXPRESS OR IMPLIED, INCLUDING MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON‑INFRINGEMENT, AND THAT OPERATION WILL BE UNINTERRUPTED OR ERROR‑FREE.
>
> TO THE MAXIMUM EXTENT PERMITTED BY LAW, Sidiora Labs, ITS AFFILIATES AND CONTRIBUTORS ARE **NOT LIABLE** FOR INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, EXEMPLARY, OR PUNITIVE DAMAGES, OR LOST PROFITS / REVENUE / GOODWILL, ARISING FROM OR RELATED TO THIS LICENSE OR THE LICENSED WORK, EVEN IF ADVISED OF THE POSSIBILITY.

Nothing in this Section limits Sidiora Labs's ability to seek injunctive relief without bond in addition to other remedies or to enforce Your obligations under this License.
...
**11.1 Notices.** Legal or any other notices to Sidiora Labs:

> **`legal@Paxeer.app`** — subject line: **"Centra AI Notice"**
...
**11.3 Assignment.** You may not assign this License (by operation of law or otherwise) without Sidiora Labs's prior written consent; any unauthorized assignment is void. **Sidiora Labs may assign freely.**
...
Sidiora Labs may publish new or updated versions of this License from time to time. Each release of the Licensed Work is governed by the license version identified in the repository for that release. Sidiora Labs may also re‑release the Licensed Work, or any portion of it, under different license terms in future releases.
