...
// the daemon SSE Event ({seq,ts,phase,type,fields}) — and agents/neo/internal/trace's
...
//
// It lives here in packages/construct/schema (not in surfacestore) because it is a wire
