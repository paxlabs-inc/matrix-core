...
const { collectFiles, detectLaunch, handleMcpRequest, isDirectExecution } = await import('../../../protocol/tools/sandbox/sandbox.mjs')
...
test('Railway runtime symlink is recognized as direct execution', () => {
  const bridgePath = fileURLToPath(new URL('../../../protocol/tools/sandbox/sandbox.mjs', import.meta.url))
