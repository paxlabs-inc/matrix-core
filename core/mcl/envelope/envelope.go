...
//
// Encoding posture (locked Session 21 — matches core/cortex/scope/scope.go):
//
...
//
// Sign / Verify mirror core/cortex/scope/scope.go: callers provide a
...
// canonicalEnc / canonicalDec — same posture as core/cortex/scope.
