...
func TestABMetrics_PrometheusExposition(t *testing.T) {
	...
	for _, want := range []string{
		...
		`matrix_router_request_duration_ms_bucket{slot="executor",kind="reason",model="xiaomimimo/mimo-v2.5-pro-ultraspeed",streamed="true",le="250"} 1`,
		`matrix_router_request_duration_ms_bucket{slot="executor",kind="reason",model="xiaomimimo/mimo-v2.5-pro-ultraspeed",streamed="true",le="+Inf"} 2`,
		`matrix_router_request_duration_ms_count{slot="executor",kind="reason",model="xiaomimimo/mimo-v2.5-pro-ultraspeed",streamed="true"} 2`,
		`matrix_router_request_duration_ms_sum{slot="executor",kind="reason",model="xiaomimimo/mimo-v2.5-pro-ultraspeed",streamed="true"} 1750`,
	} {
