      ...
      {open && (
        ...
        >
          ...
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="text-muted-foreground hover:bg-muted hover:text-foreground bg-card/70 absolute right-2 bottom-2 z-30 grid size-8 place-items-center rounded-full backdrop-blur-md transition sm:right-3 sm:bottom-3 sm:size-9"
          >
            <X className="size-[0.95rem] sm:size-[1.05rem]" />
          </button>
