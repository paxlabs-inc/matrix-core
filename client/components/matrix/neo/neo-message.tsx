...
export const NEO_PROSE_CLASS = cn(
  'text-foreground min-w-0 text-[0.95rem] leading-7 [overflow-wrap:anywhere] sm:text-base',
  '[&_p]:my-3 [&_p]:text-pretty',
  '[&_h1]:mt-7 [&_h1]:mb-3 [&_h1]:text-2xl [&_h1]:leading-8 [&_h1]:font-semibold',
  '[&_h2]:mt-6 [&_h2]:mb-3 [&_h2]:text-xl [&_h2]:leading-7 [&_h2]:font-semibold',
  '[&_h3]:mt-5 [&_h3]:mb-2 [&_h3]:text-lg [&_h3]:leading-7 [&_h3]:font-semibold',
  ...
  '[&_li]:pl-1 [&_li>p]:my-1',
  '[&_a]:text-primary [&_a]:break-words [&_a]:font-medium [&_a]:underline [&_a]:underline-offset-2',
  '[&_strong]:font-semibold',
  '[&_blockquote]:bg-muted/60 [&_blockquote]:my-4 [&_blockquote]:rounded-lg [&_blockquote]:px-4 [&_blockquote]:py-2 [&_blockquote]:text-muted-foreground',
  '[&_blockquote>p]:my-1',
  '[&_pre]:bg-card [&_pre]:my-4 [&_pre]:max-w-full [&_pre]:overflow-x-auto [&_pre]:rounded-lg [&_pre]:p-4 [&_pre]:text-sm [&_pre]:leading-6',
  '[&_code]:bg-muted [&_code]:break-words [&_code]:rounded-md [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[0.88em]',
  '[&_pre_code]:bg-transparent [&_pre_code]:p-0 [&_pre_code]:text-[0.875rem]',
  '[&_img]:my-4 [&_img]:max-w-full [&_img]:rounded-lg',
  '[&_table]:my-4 [&_table]:block [&_table]:max-w-full [&_table]:overflow-x-auto [&_table]:text-sm',
  '[&_thead]:bg-muted [&_th]:px-3 [&_th]:py-2 [&_th]:text-left [&_th]:font-semibold',
  '[&_td]:px-3 [&_td]:py-2 [&_tbody_tr:nth-child(even)]:bg-muted/35',
)
  ...
  const deliveryLabel =
    message.deliveryStatus === 'honest_partial'
      ...
      : message.deliveryStatus === 'incomplete'
        ...
        : ''
  return (
    <AstryxChatMessage sender="assistant" density="spacious">
      <AstryxChatMessageBubble variant="ghost">
...
export function NeoUserMessage({ message, onFork }: { message: ChatMessage; onFork?: () => void }) {
  ...
  return (
    <AstryxChatMessage sender="user" density="spacious">
      <AstryxChatMessageBubble>
        {items.length > 0 && (
