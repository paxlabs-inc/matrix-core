  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[85vh] gap-0 overflow-hidden p-0 sm:max-w-md">
        ...
        <Tabs defaultValue="queue" className="min-h-0 gap-0 px-5 pb-5">
          ...
          <TabsContent value="queue" className="mt-3 max-h-[55vh] overflow-y-auto">
            <QueueTab t={t} active={open} />
          </TabsContent>
          <TabsContent value="inbox" className="mt-3 max-h-[55vh] overflow-y-auto">
