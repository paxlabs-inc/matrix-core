...
const OnboardingFlow = dynamic(() =>
  import('@/components/matrix/onboarding/onboarding-flow').then((module) => module.OnboardingFlow),
)
const ProvisioningScreen = dynamic(() =>
  import('@/components/matrix/provisioning-screen').then((module) => module.ProvisioningScreen),
)
