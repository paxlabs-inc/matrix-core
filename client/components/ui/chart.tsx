...
// Recharts v3 no longer surfaces the rendered tooltip/legend payload through
// its exported prop types (those props are injected into the `content` element
// at runtime), so we describe the item shapes we actually read.
