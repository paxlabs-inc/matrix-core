  ...
  return (
    ...
    >
      {showFill && (
        <>
          ...
          <polygon
            ...
            fill={`url(#${gradientId})`}
            className="animate-in fade-in fill-mode-both duration-1000 ease-[cubic-bezier(0.16,1,0.3,1)]"
      ...
      <polyline
        ...
        strokeDashoffset={0}
        strokeOpacity={0.2}
        className="motion-safe:animate-in motion-safe:fade-in motion-safe:fill-mode-both opacity-0 motion-safe:duration-700 motion-safe:ease-out"
      ...
      <polyline
        ...
        strokeDashoffset={0}
        strokeOpacity={0.65}
        className="motion-safe:animate-in motion-safe:fade-in motion-safe:fill-mode-both opacity-0 motion-safe:duration-500 motion-safe:ease-out"
