...
import { DecisionResultSchema, type DecisionAction, type DecisionResult } from './schema'
...
>({
  ...
  if (!id) {
    throw new Error('DecisionActions requires a ToolUI provider or an explicit id prop.')
  }
