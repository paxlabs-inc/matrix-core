...
import { ChevronDownIcon, PaperclipIcon } from '@/lib/matrix-icons'
...
export const QueueItemImage = ({ ...props }: QueueItemImageProps) => (
  // eslint-disable-next-line @next/next/no-img-element -- remote provider logo SVG from models.dev; next/image is unsuitable for arbitrary remote SVGs
  <img {...props} alt="" />
)
