...
//   PAXEER_AGENT_KEYFILE | MATRIX_EXECUTOR_KEYFILE | ${MATRIX_DATA_DIR|/data}/.centra/executor.key
...
//
// Run `node protocol/tools/chronos/chronos.mjs --selftest` to smoke it offline (drift guard).
...
// The Centra AI plan IR carries every tool-call arg as a string (core/mcl/ir/plan.go),
...
const AGENT = {
  keyfile:
    ...
    `${pickEnv('MATRIX_DATA_DIR') || '/data'}/.centra/executor.key`,
