# `protocol/tools/e2e/` — mcl-e2e sweep harness
...
protocol/tools/e2e/run_sweep.sh -n 2 -o /root/matrix/runs/sweep-smoke

# Skip the Together cross-model run to save budget.
protocol/tools/e2e/run_sweep.sh --skip-together

# Background: detach + tail-friendly log.
nohup protocol/tools/e2e/run_sweep.sh -n 50 > /root/matrix/runs/sweep.nohup 2>&1 &
```
