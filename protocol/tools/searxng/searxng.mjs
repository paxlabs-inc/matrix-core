...
// them. Same shape as protocol/tools/browser/browser.mjs + tools/tachyon/tachyon.mjs:
...
//
// Wire protocol mirrors protocol/tools/websearch/web-search.mjs (newline-delimited
// JSON-RPC over stdio, zero npm deps, Node 18+ global fetch).
// Run `node protocol/tools/searxng/searxng.mjs --selftest` to smoke it offline.
