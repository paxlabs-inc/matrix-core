...
import { Stack, Button } from '@{scope}/components';
...
### usePromiseResult (Example Hook)

```typescript
import { usePromiseResult } from '@{scope}/kit/src/hooks/usePromiseResult';
