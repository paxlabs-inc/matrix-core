...
import (
	...
	"centra/agents/neo/internal/automatrixlog"
	"centra/agents/neo/internal/automatrixsettings"
	"centra/agents/neo/internal/briefhistory"
	"centra/agents/neo/internal/briefsettings"
	...
	"centra/agents/neo/internal/runrecord"
	sbx "centra/agents/neo/internal/sandbox"
	"centra/agents/neo/internal/server"
	...
	"centra/agents/neo/internal/trace"
	"centra/agents/neo/internal/writeback"
...
func runServe(args []string) {
	...
	// spawning MCP servers so the co-located media bridge (protocol/tools/media) writes
	...
	// The desktop bridge (protocol/tools/desktop/desktop.mjs) posts bytebotd actions to
