...
import (
	...
	cgstore "centra/protocol/codegraph/store"
...
func findNeocortexBinary() (string, error) {
	...
	for {
		for _, relative := range []string{filepath.Join("core", "neocortex", "build", "debug", "cortexd"), filepath.Join("core", "neocortex", "build", "repro-a", "cortexd")} {
