...
// escalate to MCL) — comes from the frozen design spec at agents/neo/neo.frozen.kvx
...
type Config struct {
	...
	// --- models (provider-qualified ids; see centra/core/mcl/llm DetectProvider) ---
...
// operational contract (agents/neo/neo.frozen.kvx).
func Default() Config {
	return Config{
		AgentName:      "Morpheus",
