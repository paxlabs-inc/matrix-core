...
/** Max hue spread from basewider for richer color variation */
const HUE_SPREAD = 45;
...
const AgentAvatar = ({
  ...
  useEffect(() => {
    ...
    const draw = (time: number) => {
      ...
      // Scale pulsewhole avatar breathes
      ...
      for (let y = 0; y < GRID_SIZE; y++) {
        for (let x = 0; x < GRID_SIZE; x++) {
          ...
          // Sparkleoccasional bright flash
          ...
          // Pixel glowsubtle shadow per cell
